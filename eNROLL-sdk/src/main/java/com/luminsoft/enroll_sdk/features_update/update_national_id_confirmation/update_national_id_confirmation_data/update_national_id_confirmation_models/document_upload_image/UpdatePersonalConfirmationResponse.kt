...
data class UpdateNationalIDConfirmationResponse(

    @SerializedName("isSuccess") var isSuccess: Boolean? = null,
    @SerializedName("message") var message: String? = null,
    @SerializedName("passportData") var passportData: UpdateCustomerData? = UpdateCustomerData(),
    @SerializedName("customerData") var customerData: UpdateCustomerData? = UpdateCustomerData(),
)
